...
class SellCardScanner extends StatefulWidget {
  const SellCardScanner({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _QrScannerState();
}

class _QrScannerState extends State<SellCardScanner> {
  Barcode? result;
